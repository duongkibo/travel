import { Entity, Column, DeepPartial, CreateDateColumn, UpdateDateColumn, ManyToMany, JoinTable, ManyToOne, JoinColumn } from 'typeorm';
...
@ObjectType({
  ...
  export class UserBookTour implements Node {
    ...
    @Column({ nullable: false, type: 'enum', enum: StatusTour, default: StatusTour.PENDING })
    status: StatusTour;
