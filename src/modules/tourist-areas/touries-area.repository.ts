...
import { PaymentCard, TouristArea, TouristAreasRates, UserBookTour, UserLocation } from './tourist-area.entity';
...
@EntityRepository(TouristAreasRates)
export class TouristAreasRatesRepository extends CommonRepository<TouristAreasRates> {}